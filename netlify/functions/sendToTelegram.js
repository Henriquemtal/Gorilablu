...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        const TELEGRAM_BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN; // "7014071115:AAEjuxe55yPXOxAKegwa1fBShXYd9ZOTQFs"
        const TELEGRAM_CHAT_ID = process.env.TELEGRAM_CHAT_ID;     // "7014071115"
